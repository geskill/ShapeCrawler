...
public class ParagraphCollectionTests : SCTest
{
    ...
    public void Add_adds_paragraph_in_the_middle()
    {
        ...
        // Assert
        addedShape.TextBox.Text.Should()
            .Be($"Paragraph 1{Environment.NewLine}New Paragraph 2{Environment.NewLine}Paragraph 2");
    ...
    public void Add_adds_paragraph_at_the_beginning()
    {
        ...
        var pres = new Presentation(pres =>
        {
            pres.Slide(slide => { slide.TextShape("TextBox 1", 100, 100, 200, 200, "Paragraph 1"); });
        });
        var slide = pres.Slide(1);
        var addedShape = slide.Shapes.Last();
        var paragraphs = addedShape.TextBox!.Paragraphs;
