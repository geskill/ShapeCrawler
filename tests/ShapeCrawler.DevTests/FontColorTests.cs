...
public class FontColorTests : SCTest
{
    ...
    {
        // Arrange
        var nonPlaceholder = new Presentation(TestAsset("001.pptx")).MasterSlides[0].Shapes.First(sp => sp.Id == 8);
        var colorFormat = nonPlaceholder.TextBox.Paragraphs[0].Portions[0].Font.Color;
    ...
    {
        // Arrange
        var titlePlaceholder = new Presentation(TestAsset("001.pptx")).MasterSlides[0].Shapes.First(sp => sp.Id == 2);
        var colorFormat = titlePlaceholder.TextBox.Paragraphs[0].Portions[0].Font.Color;
    ...
    [Test]
    [SlidePortion("Test Case #1", "020.pptx", 1, 2, 1, 1, "000000")]
    [SlidePortion("Test Case #2", "020.pptx", 1, 3, 1, 1, "000000")]
    [SlidePortion("Test Case #3", "020.pptx", 3, 8, 2, 1, "FFFF00")]
    [SlidePortion("Test Case #4", "001.pptx", 1, 4, 1, 1, "000000")]
    [SlidePortion("Test Case #5", "002.pptx", 2, 3, 1, 1, "000000")]
    [SlidePortion("Test Case #6", "026.pptx", 1, 128, 1, 1, "000000")]
    [SlidePortion("Test Case #7", "autoshape-case017_slide-number.pptx", 1, 5, 1, 1, "000000")]
    [SlidePortion("Test Case #8", "031.pptx", 1, 44, 1, 1, "000000")]
    [SlidePortion("Test Case #9", "033.pptx", 1, 3, 1, 1, "000000")]
    [SlidePortion("Test Case #10", "038.pptx", 1, 102, 1, 1, "000000")]
    [SlidePortion("Test Case #11", "001.pptx", 3, 4, 1, 1, "000000")]
    [SlidePortion("Test Case #12", "001.pptx", 5, 5, 1, 1, "000000")]
    [SlidePortion("Test Case #13", "034.pptx", 1, 2, 1, 1, "000000")]
    [SlidePortion("Test Case #14", "035.pptx", 1, 9, 1, 1, "000000")]
    [SlidePortion("Test Case #15", "036.pptx", 1, 6146, 1, 1, "404040")]
    [SlidePortion("Test Case #16", "037.pptx", 1, 7, 1, 1, "1A1A1A")]
    [SlidePortion("Test Case #17", "014.pptx", 1, 61, 1, 1, "595959")]
    [SlidePortion("Test Case #18", "014.pptx", 6, 52, 1, 1, "FFFFFF")]
    [SlidePortion("Test Case #19", "032.pptx", 1, 10242, 1, 1, "0070C0")]
